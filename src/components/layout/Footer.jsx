        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/#agency" className="hover:text-blue-600 transition-colors">Digital Marketing Agency</Link></li>
              <li><Link to="/#web-dev" className="hover:text-blue-600 transition-colors">Website Development</Link></li>
            </ul>
          </div>
