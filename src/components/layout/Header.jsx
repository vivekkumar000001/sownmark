    ...
    <header className="fixed w-full z-50 bg-white shadow-md py-3">
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8 text-slate-700 font-medium">
          ...
          <NavItem to="/agency" label="Agency" />
          <NavItem to="/webdevelopment" label="WebDevlopment" />
          <Link
            to="/contact"
      ...
      {menuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <ul className="flex flex-col py-4 px-4 gap-2 text-slate-700 font-medium">
            ...
            <MobileNavItem to="/agency" label="Agency" />
            <MobileNavItem to="/webdevelopment" label="WebDevlopment" />
          </ul>
        </div>
      )}
    </header>
