// src/pages/HiringSolutionsPage.jsx
...
const HiringSolutionsPage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-50 to-indigo-50 py-24 md:py-32">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-800 mb-12">Domain-Specific Recruitment</h2>
          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
            {domains.map(domain => (
              <div key={domain.id} className="bg-slate-50 p-6 rounded-xl shadow hover:shadow-lg transition">
                <h3 className="text-xl font-semibold text-blue-600 mb-4">{domain.title}</h3>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-800 mb-12">Our Hiring Process</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-800 mb-12">Why Partner with Sownmark?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map(item => (
              <div key={item.id} className="bg-slate-50 p-6 rounded-xl text-center shadow hover:shadow-lg transition">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-lg text-blue-100 mb-8">Share your hiring needs and let Sownmark find your next star performer.</p>
          <Link
            to="/contact"
            className="inline-block bg-white text-blue-600 font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-100 transition"
          >
