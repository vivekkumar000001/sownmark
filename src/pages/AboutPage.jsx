...
const AboutPage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-cyan-300 to-white-100 pt-24 pb-16 md:pt-32 md:pb-24">
      ...
      {/* Team Section */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-cyan-300 to-blue-200 text-white">
        <div className="container mx-auto px-4">
