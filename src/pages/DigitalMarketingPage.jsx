...
<div className="min-h-screen bg-white">
  {/* Hero Section */}
  <section className="h-screen px-4 bg-gradient-to-br from-blue-50 to-cyan-100 flex items-center">
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
      ...
      {/* Teaching Philosophy */}
      <section className="py-12 px-4 bg-blue-900 via-cyan-200 to-cyan-100">
      ...
      {/* CTA Section */}
      <section className="py-12 px-4 bg-blue-900 to-blue-700 text-white">
