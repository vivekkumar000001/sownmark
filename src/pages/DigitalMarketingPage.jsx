...
const DigitalMarketingPage = () => {
  const courses = [
    ...
    {
      icon: <FaHandshake className="text-violet-500 text-2xl" />,
  ...
  const testimonials = [
    {
      id: 1,
      quote: "Sownmark's digital marketing course transformed my career. The practical approach gave me the confidence to apply what I learned immediately.",
      name: "Sarah Johnson",
