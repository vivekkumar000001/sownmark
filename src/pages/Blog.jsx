...
const Blog = () => {
  ...
  const blogPosts = [
    { id: 1, title: "5 Essential Digital Marketing Skills for 2025", excerpt: "Discover the top skills you need to stay competitive in the evolving digital landscape.", author: "Alex Johnson", date: "June 15, 2025", readTime: "4 min read", imageType: "graph", link: "https://blog.hubspot.com/marketing/digital-marketing-skills" },
    { id: 2, title: "SEO Checklist: How to Rank Higher on Google", excerpt: "A practical step-by-step guide to optimizing your website for better search engine visibility.", author: "Sarah Williams", date: "June 8, 2025", readTime: "6 min read", imageType: "infographic", link: "https://moz.com/blog/seo-checklist" },
    { id: 3, title: "The Ultimate Guide to Social Media Content Planning", excerpt: "Learn how to create engaging content calendars that drive consistent audience engagement.", author: "Mike Chen", date: "June 1, 2025", readTime: "5 min read", imageType: "screenshot", link: "https://buffer.com/library/social-media-content-calendar/" },
    { id: 4, title: "Hiring Your First Digital Marketing Manager", excerpt: "Key qualities to look for when building your marketing team and scaling your efforts.", author: "Priya Patel", date: "May 25, 2025", readTime: "3 min read", imageType: "team", link: "https://www.workable.com/hr-toolkit/how-to-hire-digital-marketing-manager/" },
    { id: 5, title: "Why Responsive Web Design is Non-Negotiable", excerpt: "Understanding how mobile-first design impacts user experience and conversion rates.", author: "David Kim", date: "May 18, 2025", readTime: "4 min read", imageType: "ui", link: "https://www.smashingmagazine.com/2018/01/responsive-web-design/" },
    { id: 6, title: "Leveraging Artificial Intelligence in Digital Marketing", excerpt: "Explore practical applications of artificial intelligence in modern marketing strategies.", author: "Emma Rodriguez", date: "May 10, 2025", readTime: "7 min read", imageType: "abstract", link: "https://blog.hootsuite.com/ai-digital-marketing/" }
  ];

  const categories = ['SEO', 'Social Media', 'Web Development', 'Hiring', 'Marketing Tips', 'Analytics', 'Case Studies'];

  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-300">
     <header className="bg-cyan-100 text-black pt-24 pb-12 sm:pt-32 sm:pb-16 px-4 sm:px-6 text-center">
  <div className="max-w-4xl mx-auto">
    <h1 className="text-4xl md:text-5xl font-bold mb-8">Sownmark Blog</h1>
    <p className="text-xl opacity-90">
      Insights & Innovations in Digital Marketing, Recruitment, and Web Development
    </p>
  </div>
</header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="flex flex-col lg:flex-row lg:gap-8">
          <main className="lg:w-2/3">
            <div className="mb-10 bg-white p-4 sm:p-6 rounded-xl shadow-md">
            ...
            <div className="mb-12 bg-white rounded-xl overflow-hidden shadow-lg">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-2/3 p-4 sm:p-6">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800">Understanding Google Analytics 4: A Beginner's Guide</h2>
                ...
                <article key={post.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <a href={post.link} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 font-medium flex items-center">
                        Read More
